...
AnalogKeys::AnalogKeys(byte analog_pin, byte nbr_keys)
{
  _pin_nbr[0] = col1;
  _pin_nbr[1] = col2;
...
/* Keyboard layout 
  ...
  {'*','0','#','D'}
*/
void AnalogKeys::set_aval(byte key_indx, unsigned int key_value){
    key_val[key_indx] = key_value;
}    

//int kbdPin = 15; 
int AnalogKeys::rd_analog(byte cIndx){
